<div class="flex flex-row gap-2 items-center justify-center my-4">
    <a href="/change-language/en" class="block w-6 h-6 {{ app()->currentLocale() == 'en' ? 'lng-selected' : '' }}"
    title="in English">
    ...
    <a href="/change-language/fr" class="block w-6 h-6 {{ app()->currentLocale() == 'fr' ? 'lng-selected' : '' }}"
    title="en français">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 40">
    ...
    <a href="/change-language/nl" class="block w-6 h-6 {{ app()->currentLocale() == 'nl' ? 'lng-selected' : '' }}"
    ...
    <a href="/change-language/de" class="block w-6 h-6 {{ app()->currentLocale() == 'de' ? 'lng-selected' : '' }}"
    title="auf Deutsch">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 40">
